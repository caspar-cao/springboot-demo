...
public class DataConfig {
	...
	public SqlSessionFactoryBean mybatisSqlSession() throws IOException{
		...
		ssfb.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/jingyunbank/demo/springboot/mapper/*Mapper.xml"));
		return ssfb;
	}
	...
	public MapperScannerConfigurer mapperScanner(){
		...
		msc.setBasePackage("com.jingyunbank.demo.springboot.dao");
		return msc;
	}
